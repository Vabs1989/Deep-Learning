...
csvlogger_callback = CSVLogger(logs_path)
...
# def sum_of_binary_crossentropy(y_true, y_pred):
#     # y_true = K.print_tensor(y_true, message='y_true = ')
#     # y_pred = K.print_tensor(y_pred, message='y_pred = ')
#     calc_loss = K.mean(-1*(y_true * K.log(y_pred) + (1 - y_true) * K.log(1 - y_pred)))
#     return calc_loss
#
# loss_func = sum_of_binary_crossentropy
# CUSTOM LOSS FUNCTION ENDS
...
# Plot auc & lr values
plt.plot(history.history['avg_of_class_aucs'])
